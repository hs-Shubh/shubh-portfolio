...
const groups = [
  ...
  {
    name: 'Backend',
    skills: ['Node.js', 'Express.js', 'Prisma', 'NextAuth', 'PostgreSQL'],
    icon: '⚙️'
  },
  {
    name: 'AI & Automation',
    skills: ['NLP', 'Transformers', 'AI Agents', 'n8n Workflows', 'Prompt Engineering', 'LLMs'],
    icon: '🤖'
  },
  {
    name: 'Databases & Tools',
    skills: ['PostgreSQL', 'MySQL', 'Odoo', 'Git', 'Vercel', 'Streamlit', 'WordPress'],
    icon: '🛠️'
  }
]
