...
const items: ExperienceItem[] = [
  {
    ...
    achievements: [
      ...
      'Shipped automation-heavy products: finance tooling, HR hiring automation, procurement (CPS), and Places-backed lead scraping with Supabase',
      'Implemented Row-Level Security (RLS) policies for secure data access where PostgreSQL powers the product',
      'Created AI agents for marketing and SEO workflows using n8n and LLM pipelines'
    ],
    tech: ['React', 'Next.js', 'Supabase', 'AWS', 'n8n', 'PostgreSQL', 'AI Agents']
  },
  {
